...
data_1 <- list(
  tags$p("The first question is: What is the percentage of positive cases from
...
page_summary <- tabPanel(
  ...
  disease. Besides, we might want to question the effectiveness of our way in
  conducting testing because our way of testing can control the spread of the
  COVID-19, especially in communities."),
